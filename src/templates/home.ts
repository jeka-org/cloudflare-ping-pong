...
<head>
  ...
  <meta name="description" content="Real-time multiplayer Pong on Cloudflare's Edge. Play against friends or AI, watch live games, climb the leaderboard.">
  <meta property="og:title" content="Global Pong">
  <meta property="og:description" content="Real-time multiplayer Pong on Cloudflare's Edge. Play against friends or AI, watch live games, climb the leaderboard.">
  <meta property="og:image" content="https://spark.jeka.org/a-dark-space-themed-banner-for-a-multipl.png">
  <meta property="og:url" content="https://pong.jeka.org">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Global Pong">
  <meta name="twitter:description" content="Real-time multiplayer Pong on Cloudflare's Edge">
  <meta name="twitter:image" content="https://spark.jeka.org/a-dark-space-themed-banner-for-a-multipl.png">
  <style>
